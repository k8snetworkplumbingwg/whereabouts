...
func ExtractIPPoolFrom(iPPool *whereaboutscnicncfiov1alpha1.IPPool, fieldManager string, subresource string) (*IPPoolApplyConfiguration, error) {
	b := &IPPoolApplyConfiguration{}
	err := managedfields.ExtractInto(iPPool, internal.Parser().Type("com.github.k8snetworkplumbingwg.whereabouts.api.whereabouts.cni.cncf.io.v1alpha1.IPPool"), fieldManager, b, subresource)
	if err != nil {
		return nil, err
	}
